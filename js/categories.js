...
import { showToast, categoryColorClasses, showElement, hideElement } from './utils.js';
...
export function setupCategoriesListener() {
    ...
    unsubscribeCategories = onSnapshot(categoriesDocRef, (docSnap) => {
        ...
        // Update budget form with new categories
        import('./budget.js').then(budget => budget.initBudgetForm());
    }, (error) => {
